                ...
                <div className='col-6 m-auto'>
                    <form method='POST' action={`/places/${id}?_method=PUT`}>
                        <div className='form-group mb-3'>
                            ...
                            <input className='form-control' type="text" placeholder='The place...' name='name' value={place.name} required />
                        </div>
                        <div className='form-group mb-3'>
                        ...
                        <div className='form-group mb-3'>
                            ...
                            <input className='form-control' type="text" placeholder='City Name...' name='city' value={place.city} />
                        </div>
                        <div className='form-group mb-1'>
                            <label htmlFor="state">State</label>
                            <select className='form-control' name="state" id="state" value={place.state}>
