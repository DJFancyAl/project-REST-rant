    ...
    return (
        <Def>
            ...
            <form method='POST'>
                ...
                <input type="text" placeholder='Your place...' name='name' value={place.name} />
                <label htmlFor="city">City</label>
                <input type="text" placeholder='City Name...' name='city' value={place.city} />
                <label htmlFor="state">State</label>
                <select name="state" id="state" value={place.state}>
                ...
                <input type="text" placeholder='Image url...' name='image' value={place.image} />
